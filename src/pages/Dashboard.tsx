...
const packagePresets: PackagePresets = {
  'Penetration Testing': [
    { label: 'Basic Assessment', price: 200000 },
    { label: 'Standard Pentest', price: 500000 },
    { label: 'Advanced Audit', price: 1200000 },
    { label: 'Enterprise Audit', price: 2500000 },
  ],
  'Smart Contract Audit': [
    { label: 'Basic Audit', price: 1000000 },
    { label: 'Standard Audit', price: 2000000 },
    { label: 'Enterprise Audit', price: 4000000 },
  ],
  'Recon Reports': [
    { label: 'Pro Recon', price: 100000 },
    { label: 'Standard Recon', price: 180000 },
    { label: 'Deep Recon', price: 350000 },
  ],
  'Web Development': [
    { label: 'Premium Starter', price: 150000 },
    { label: 'Business Website', price: 350000 },
    { label: 'Pro Platform', price: 800000 },
    { label: 'Enterprise E-comm', price: 1500000 },
  ],
  'App Development': [
    { label: 'Secure MVP', price: 1200000 },
    { label: 'Standard Hardened App', price: 3000000 },
    { label: 'Pro Architecture', price: 6000000 },
    { label: 'Fintech Platform', price: 10000000 },
  ],
  'Cloud Infrastructure': [
    { label: 'Cloud Setup', price: 350000 },
    { label: 'Cost Optimization', price: 650000 },
    { label: 'Advanced DevOps', price: 1200000 },
  ],
  'Custom Scripts': [
    { label: 'Pro Scripting', price: 80000 },
    { label: 'Standard System', price: 150000 },
    { label: 'Advanced Worker', price: 300000 },
  ],
  'AI Agent & Automation': [
    { label: 'Implementation', price: 450000 },
    { label: 'RAG System', price: 900000 },
    { label: 'Workforce Suite', price: 1800000 },
    { label: 'Custom ML Model', price: 3500000 },
  ],
  'UI & Frontend Design': [
    { label: 'Basic Design', price: 150000 },
    { label: 'Standard Brand System', price: 350000 },
    { label: 'Pro Motion Design', price: 650000 },
    { label: 'Full Brand Production', price: 1200000 },
  ],
  'Maintenance': [
    { label: 'Website Baseline', price: 75000 },
    { label: 'App Management', price: 250000 },
    { label: 'System Guard', price: 180000 },
    { label: 'AI Stewardship', price: 350000 },
  ],
  'Compliance as a Service': [
    { label: 'Basic Audit', price: 400000 },
    { label: 'Full Framework', price: 850000 },
    { label: 'Elite Governance', price: 1800000 },
  ],
  'Retainer Plans': [
    { label: 'Basic Partner', price: 150000 },
    { label: 'Business Priority', price: 400000 },
    { label: 'Elite Retainer', price: 1000000 },
  ],
};
