...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const whatsappUrl1 = `https://wa.me/2349164703407?text=${encodeURIComponent(message)}`;
      const whatsappUrl2 = `https://wa.me/2349131744823?text=${encodeURIComponent(message)}`;
      
      // Open WhatsApp for both numbers in new tabs
